...
export default function CourseViewer() {
  ...
  // جلب سجل تقدم الطالب في الفيديوهات
  ...
  const handleMarkAsCompleted = async () => {
    ...
    try {
      ...
      if (!progressSnap.exists() || !progressSnap.data().isCompleted) {
        ...
        // 2. زيادة نقاط الطالب الإجمالية (+10 نقاط)
          ...
          <div className="lg:col-span-2 space-y-6">
            {activeContent?.contentType === 'Video' ? (
              <div className="space-y-6 animate-in fade-in duration-700">
                <div className="relative aspect-video rounded-[2.5rem] overflow-hidden bg-black shadow-2xl border border-white/5 group select-none">
                   <ReactPlayer
                  ...
                  <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-6">
                    <div className="text-right flex-grow">
                      ...
                      <div className="flex items-center gap-3 justify-end opacity-70">
                         <Badge className="bg-accent/10 text-accent text-[10px] font-black border-accent/20">حصة مؤمنة ✓</Badge>
